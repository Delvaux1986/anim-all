<template>
    <table class="table-fixed bg-white p-1">
        <thead class="table-row-group">
            <tr class="table-row">
                <th class="table-cell text-left">Photo</th>
                <th class="table-cell text-left w-2/12">Nom</th>
    ...
    <tbody class="table-row-group">
        <tr v-for="(cage,id) in laravelData.data" :key="id">
            ...
            <th class="table-cell text-left w-2/12">{{cage.name ? cage.name : 'N/A'}}</th>
            <th class="table-cell text-left">{{cage.type ? cage.type : 'N/A'}}</th>
            <th class="table-cell text-left">{{cage.lunchtimeFirst ? cage.lunchtimeFirst.substr(0, 5) : 'N/A'}}</th>
            <th class="table-cell text-center">{{cage.checkFirstLunchtime ?  'Oui' : 'Non'}}</th>
            <th class="table-cell text-left">{{cage.lunchtimeTwo ? cage.lunchtimeTwo.substr(0, 5) : 'N/A'}}</th>
            <th class="table-cell text-left">{{cage.checkSecondLunchtime ? 'Oui' : 'Non'}}</th>
            <th class="table-cell text-left">{{cage.animals ? 'Oui' : 'Non'}}</th>

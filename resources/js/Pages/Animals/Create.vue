...
<div class="w-screen min-h-screen bg-white">
    ...
    <form class="flex flex-col justify-center items-center" @submit.prevent="submit">
        ...
        <div class="mb-4 w-2/4">
            ...
            <select name="animalFamily" id="" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="form.family_id">

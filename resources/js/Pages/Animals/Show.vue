<template>
    <div class="w-screen min-h-screen bg-white flex justify-center items-center">
        <Menu></Menu>
        <!-- CARD -->
        ...
        <!-- IMG PROFILE -->
        <img class="rounded-full w-20 h-20 shadow-sm absolute -top-8 transform md:scale-110 duration-700" :src="this.animal.img_url" alt="" />
